...
في المثال السابق، تم تعريف متغير في الأصل باسم `Saad`، ثم تم تجاوزه ليكون
`Yahya`. ثم تعرض وحدة التحكم السلسلة `Yahya`.
...
```js
const PASSWORD = 2009;
PASSWORD = 27; // حدوث خطأ بسبب اعاده تعيين
```
